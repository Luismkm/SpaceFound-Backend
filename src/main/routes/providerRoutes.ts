...
import { makeLoadProvidersController, makeLoadProviderByIdController } from '../factories/controllers/provider/loadProvider/loadProvidersControllerFactory';
...
export default (router: Router): void => {
  ...
  router.get('/provider/:providerId/profile', adaptRoute(makeLoadProviderByIdController()));
};
